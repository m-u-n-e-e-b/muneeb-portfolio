...
import { skills } from "@/data/content/home.js";
  ...
  return (
    <div className="flex flex-col md:flex-row justify-between relative">
      <h2 className="relative text-3xl w-full text-center md:text-left font-bold md:max-w-lg mb-10 md:mr-10 md:mb-0 md:w-max mr-0 ">
        I got the  <span className="heroShiny2 text-fun-pink">experience. </span>
        <br />
        Here is my toolbelt for <span className="heroShiny2 text-fun-pink">success. </span>
        <img
