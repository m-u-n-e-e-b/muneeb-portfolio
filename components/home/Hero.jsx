...
function Hero() {
  return (
    <>
      ...
      >
        <p className="text-xl mb-5">Hey, I'm Muneeb.</p>
        <h1 className="heroTitle inline-block max-w-2xl lg:max-w-4xl  w-auto relative text-5xl md:text-6xl lg:text-7xl tracking-tighter mb-10 font-bold heroShinyBg">
          ...
          <span className="heroShiny2 text-fun-pink"> web. </span>
          <img
          ...
          />
         <img
            className="sqD bottom-[-404px] -right-1/4 sm:right-[-20%] lg:bottom-[-380px] lg:right-[-120px] w-[400px] rotate-45"
            style={{ animationDelay: "0.3s" }}
            src="/static/doodles/hero/muneeb.png"
          />
